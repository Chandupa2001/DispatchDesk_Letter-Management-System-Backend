...
// Model for action-taken records
...
const recordActionTaken = async (req, res) => {
    ...
    try {
      ...
      const record = await establishmentModel.findOne({ refNo });
      ...
      await establishmentModel.deleteOne({ refNo });
...
export { fectchRecords, fectchRegRecords, getActionTakenRecords, recordActionTaken };
